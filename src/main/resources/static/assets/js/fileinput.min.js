...
(function (e) {
    ...
    c.prototype = {
        constructor: c, listen: function () {
            ...
            var t = this;
            var n = t.$element, r = n.get(0).files, i = r ? r.length : 1, o = n.val().replace(/\\/g, "/").replace(/.*\//, ""), u = t.$preview, c = t.$previewContainer, h = t.$previewStatus, p = t.msgLoading, d = t.msgProgress, v = t.msgSelected, m, g = t.previewFileType, y = parseInt(t.wrapTextLength), b = t.wrapIndicator;
                    ...
                    if (u.length > 0 && (g == "any" ? n || r : g == "text" ? r : n) && typeof FileReader !== "undefined") {
                        ...
                        i.onload = function (e) {
                            ...
                            if (r) {
                                ...
                                if (o.length > y) {
                                    var a = l(), f = window.innerHeight * .75, i = s.replace("{id}", a).replace("{title}", t).replace("{body}", o).replace("{height}", f);
